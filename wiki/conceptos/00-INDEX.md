...
Welcome to the **Axolotto Concept Wiki** — a player-friendly encyclopedia of everything in the Axolotto universe. Think of it as the Pokédex for Axolotto.

**Axolotto** is a Web3 Mexican Lotería game set in **Xochimilco Digital**. You collect Axolotitos (NFT digital pets), build Lotería boards, compete in multiplayer rooms, and earn rewards in a dual-currency economy.

### Where to start?

| You want to... | Read this |
|---------------|-----------|
| Understand the world | [[01-bienvenido-a-xochimilco]] |
| Learn how to play | [[06-como-jugar-loteria]] |
| Understand your Axolotito | [[02-axolotitos]] |
| Know the currencies | [[12-economia-dual]] |
| Play for free | [[25-f2p-guia-gratis]] |
| Get better | [[26-consejos-y-estrategias]] |

All pages have a **Quick Reference** table at the bottom with key numbers in both Spanish and English.

→ **For developers and AI agents**, see the [technical wiki](../00-INDEX.md) in `wiki/`.

---

→ Back to top: [[00-INDEX]]
